...
class UserController extends Controller 
{
    ...
    {   
        ...
        if ($userID) {
            ...
            if ($groupID) {
                /*if ($groupID == 2) {
                    $this->redirect('VipCenter/index');  
                }else{
                    $this->redirect('PersonalCenter/index');
                }*/
             }
        }
    ...
    {   
        ...
        // 实例化Model,进行自动验证
        $userModel = D('User');
        $res = $userModel->create($_POST,4);  //创建数据对象并且自动进行验证
    ...
    {   
        ...
        if ($res) {
            ...
            if ($res) {
                ...
                $res = SendMail($userModel->email,'猿客栈重设你的密码',$content);
                if ($res) {
