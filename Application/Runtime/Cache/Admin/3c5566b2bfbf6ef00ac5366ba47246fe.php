...
<div class="container">
    ...
    <form class="form-signin" method="post" action="/yuan/index.php/Admin/User/dologin">
        <h2 class="form-signin-heading">登录系统</h2>
        <input type="text" name="username" class="input-block-level" placeholder="账号">
        <input type="password" name="password" class="input-block-level" placeholder="密码">
        <input type="text" name="verifyCode" class="input-medium" placeholder="验证码"><img src="/yuan/index.php/Home/User/getVerifyCode" alt="" class="verifyCodeImg" id="verifyCodeImg" />
        <br/>
    ...
    $(function(){
        ...
        $('#verifyCodeImg').attr('src','/yuan/index.php/Home/User/getVerifyCode?r='+Math.random());
    })
    })
    </script>
</div>
