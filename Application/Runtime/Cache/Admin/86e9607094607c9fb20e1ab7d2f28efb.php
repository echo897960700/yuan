...
<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <select name="cid">
                    ...
                    <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v["id"]); echo ($v["html"]); echo ($v["name"]); ?>">
        ...
        <tr>
            ...
            <td>
                <?php if(is_array($attr)): foreach($attr as $key=>$vo): ?><label style="margin-right:10px;">
                            <input type="checkbox" name="aid[]" value="<?php echo ($vo["id"]); ?>" />&nbsp;<?php echo ($vo["name"]); ?>
