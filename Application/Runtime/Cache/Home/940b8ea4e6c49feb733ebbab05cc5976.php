...
<style type="text/css">
*{ padding: 0; margin: 0; }
body{ background:url(/Public/images/bg.jpg); background-size:cover;  font-family: '微软雅黑'; color: #fff; font-size: 16px; }
...
<div>
    ...
    <a id="href" id="btn-now" href="<?php echo(U('User/login')); ?>">重新登录</a> 
</div>
</div>
