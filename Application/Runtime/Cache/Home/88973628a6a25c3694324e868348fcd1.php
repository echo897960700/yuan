        ...
        <div id="form1">		    
            <form id="login-form">
                <ul>
                    ...
                    <li>
                        <div>
                            <div class="yuan"><img src="/Public/images/User/user.png" alt="" height="40px;" /></div>
                            <input type="text" name="uname" id="uname" class="login-input-style validate[required,minSize[4],maxSize[15]]">
                        </div>
                    </li>
                    <li>
                        <div class="login-input-box">
                            <div class="yuan"><img src="/Public/images/User/pass.png" alt="" height="40px;" /></div>
                    ...
                    <li class="userReg">
                        <span>还不是会员？<a href="/index.php/Home/User/userReg">立即注册</a></span>
                    </li>
                </ul>
            </form>
        </div>
	    <div class="right">
            <img src="/Uploads/blogpic/default.jpg" alt="" width="500px" height="280"> 
        </div>
</div>
...
<script type="text/javascript" src="/Public/script/Common/jquery-1.10.2.js"></script>
    ...
    <script type="text/javascript" src="/Public/script/User/login.js"></script>
    </body>
</html>