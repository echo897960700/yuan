...
<link rel="stylesheet" href="/Yuan/Public/Index/blog/css/class.css" />
<link rel="stylesheet" href="/Yuan/Public/Index/common/css/font-awesome.min.css" />
<script type='text/javascript' src='<?php echo U("Home/Blog/clickNum",array("id"=>$blog["id"]));?>'></script>
</head>
    <body>
<header>
            <div class="main">
...
<div class="content">
    <div class="content_title">
                <h1>文章分类</h1>
                <span><i class="fa fa-quote-left"></i> 分享是一种美德，让知识传递！ <i class="fa fa-quote-right"></i></span>
    </div>
    <ul class="article">
            <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><li>
                    <a href="<?php echo U('Home/Blog/Catelist',array('id'=>$v['id']));?>">
                    <div class="pic">
                        <img src="/Yuan/Uploads/catepic/<?php echo ($v["catepic"]); ?>" alt="<?php echo ($v["name"]); ?>" />
                    </div>
                     <div class="text">
                        <h2 style="color:#0099FE;font-weight:bold;">『<?php echo ($v["name"]); ?>』</h2>
                    </div>
                    <div class="icon">
