...
; (function($) {
	...
	var methods = {
		...
		init: function(data, options) {
			var defaults = {
				center: true,locked: true,fixed: true,drag: true,zIndex: 9999,opacity: "0.5",title: "分享心得--让困惑得到释放！",staySame: false,isLoading : false,width: 0,height: 0,timer: 0,left: 350,top: 100,head: true,isClose: true,shake: false,blurClose: false,close: null,init: null
			};
